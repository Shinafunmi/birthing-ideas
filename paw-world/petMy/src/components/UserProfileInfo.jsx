    ...
    <div className='relative py-4 px-6 md:px-8 bg-white'>
        ...
        <div className="w-full pt-16 md:pt-0 md:pl-36">
            <div className="flex flex-col md:flex-row items-start justify-between">
                ...
                {/* if user is not on others rofile that means he is opening his profile so we will give edit button */}
                {!profileId && 
            ...
            <div className='flex flex-wrap items-center gap-x6 gap-y-2 text-sm text-gray-500 mt-4'>
